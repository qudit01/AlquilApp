class User < ApplicationRecord
  ...
  validates :first_name, :last_name, :email, :dni, presence: { message: 'No puede estar en blanco' }
  ...
  validates :birthday, presence: { message: 'No puede estar en blanco' }
  ...
  validates :password, confirmation: { message: 'Deben coincidir' }, if: -> { new_record? || changes[:crypted_password] }
  ...
  validate :age_validation, unless: -> { birthday.nil? }
