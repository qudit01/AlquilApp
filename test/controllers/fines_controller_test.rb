...
class FinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fine" do
    assert_difference("Fine.count") do
      post fines_url, params: { fine: { motive: @fine.motive, price: @fine.price, type: @fine.type } }
    end
  ...
  test "should update fine" do
    patch fine_url(@fine), params: { fine: { motive: @fine.motive, price: @fine.price, type: @fine.type } }
